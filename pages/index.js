...
export default function Home({ name }) {
  ...
  return (
    <div className={isDarkMode ? 'scheme-dark' : ''}>
      <div
        className="fixed inset-0 background transition-all duration-1000 ease-in-out opacity-100 dark:opacity-0"
        style={{ zIndex: -1 }}></div>
      <div
        className="fixed inset-0 dark:background transition-all duration-1000 ease-in-out opacity-0 dark:opacity-100"
        style={{ zIndex: -1 }}>
        <div className="relative w-full max-w-screen mx-auto opacity-50 sm:opacity-100">
          <div className="absolute" style={{ left: '80%', top: 20 }}>
            <div className="star opacity-70 transform scale-30"></div>
          </div>
          <div className="absolute" style={{ left: '60%', top: 80 }}>
            <div className="star opacity-40 transform scale-40"></div>
          </div>
          <div className="absolute" style={{ left: '70%', top: 200 }}>
            <div className="star opacity-50 transform scale-40"></div>
          </div>
          <div className="absolute" style={{ left: '0', top: 112 }}>
            <div className="star opacity-60 transform scale-40"></div>
          </div>
          <div className="absolute" style={{ left: '50%', top: 220 }}>
            <div className="star opacity-60 transform scale-40"></div>
          </div>
          <div className="absolute" style={{ left: '44%', top: 80 }}>
            <div className="star opacity-50 transform scale-30"></div>
          </div>
          <div className="absolute" style={{ left: '12%', top: 40 }}>
            <div className="star opacity-40 transform scale-40"></div>
          </div>
          <div
            className="absolute opacity-0 sm:opacity-100"
            style={{ left: '45%', top: 60 }}>
            <div className="moon transform scale-30"></div>
          </div>
        </div>
      </div>
      <section className="fixed inset-0 overflow-auto">
        <Head>
          <title>La Ciudad Nunca Duerme {name}</title>
        ...
        <header className="relative w-full max-w-screen-lg mx-auto">
          <img
            src="/patucos.png"
            className="w-full sm:absolute sm:right-0 sm:top-0 sm:w-1/2"
          />
          <h1 className="transition-all duration-1000 ease-in-out font-blueberry absolute left-0 top-0 pt-20 text-lg tracking-wider text-teal-800 text-center sm:relative sm:left-auto sm:top-auto sm:pt-6 sm:pl-0 sm:w-1/2 sm:pt-20 sm:text-4xl dark:text-teal-500">
            ...
            <div className="inline-block px-16 transition-all duration-1000 ease-in-out text-5xl transform -rotate-10 tracking-wider text-red-400 sm:text-6xl lg:text-7xl dark:text-red-500">
              ...
              <div className="opacity-0 dark:opacity-100 transition-all duration-1000 ease-in-out">
                <div className="absolute left-0 top-0 pl-4 pt-5 sm:pl-0">
                  <div className="star opacity-70 transform scale-50"></div>
                </div>
                <div className="absolute right-0 top-0 pr-4 pt-5 sm:pr-0">
                  <div className="star opacity-80 transform scale-50"></div>
                </div>
              </div>
            </div>
          </h1>
        ...
        <footer className="text-center text-sm mt-20 mb-3 text-gray-500">
          Hecho con
          <svg
            className="inline-block h-4 text-red-500 mx-2"
          ...
          para {name} (con la ayuda de algunos amigos)
        </footer>
      </section>
    </div>
  );
...
export async function getStaticProps() {
  return {
    props: {
      name: process.env.BABY_NAME || 'Marta',
    },
  };
}
